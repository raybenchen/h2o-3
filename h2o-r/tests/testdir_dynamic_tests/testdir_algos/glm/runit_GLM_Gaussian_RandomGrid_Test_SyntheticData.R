...
#   max_real_number = 3
  ...
  Log.info("Test1: Search criteria used to train gridsearch:")
  ...
  search_criteria$max_models = NULL    # remove max_models stopping condition
  search_criteria$max_runtime_secs = runif(1, min_time_val, min_time_val*correct_model_number*time_scale)
  
  Log.info("Test3: Search criteria used to train gridsearch:")
  print(search_criteria)  # print out search criteria used
  ...
  Log.info("Test4: Search criteria used to train gridsearch:")
  print(search_criteria)  # print out search criteria used
  
  browser()
  
  if (runGLMMetricStop(predictor_names, response_name, train_data, family, nfolds, hyper_parameters, search_criteria,
                       TRUE, correct_model_number)) {
    test_failed_array[test_index] = 0
  }
  
  ###################   test 4: metric stopping conditions increasing  
  test_index = test_index+1
  rm(glm_grid1)
